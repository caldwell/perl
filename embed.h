...
#define pp_entersub_safe()	Perl_pp_entersub_safe(aTHX)
...
#define pp_method_named_safe()	Perl_pp_method_named_safe(aTHX)
#define pp_method_safe()	Perl_pp_method_safe(aTHX)
...
#define pp_rv2av_novivify()	Perl_pp_rv2av_novivify(aTHX)
#define pp_rv2cv()		Perl_pp_rv2cv(aTHX)
#define pp_rv2gv()		Perl_pp_rv2gv(aTHX)
#define pp_rv2hv()		Perl_pp_rv2hv(aTHX)
#define pp_rv2hv_novivify()	Perl_pp_rv2hv_novivify(aTHX)
