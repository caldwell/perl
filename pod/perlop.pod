...
Binary "!~" interacts with non-destructive substitute (s///r) in a way that
you might not expect. C<'x' !~ s/x/y/r> gets converted internally to C<!('x'
=~ s/x/y/r)> which evaluates to C<!'y'> and then the empty string. This is
