...
substitution on a copy of the string and return the copy whether or
not a substitution occurred. The original string will always remain
...
Examples:
    ...
    $foo = $bar =~ s/this/that/r;	# Same result using /r
