...
This process is called I<autovivification>.  If you don't want the
autovivification behavior you can use the safe arrow operator, "C<< &&-> >>"
(see L<perlop> for more details).
